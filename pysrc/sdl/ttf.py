...
_dll = dll.SDL_DLL('SDL_ttf', 'TTF_Linked_Version')
...
TTF_OpenFontRW = _dll.function('TTF_OpenFontRW',
    ...
    arg_types=[POINTER(rwops.SDL_RWops), c_int, c_int],
    return_type=_TTF_Font,
    require_return=True)
...
TTF_OpenFontIndexRW = _dll.function('TTF_OpenFontIndexRW',
    ...
    arg_types=[POINTER(rwops.SDL_RWops), c_int, c_int, c_int],
    return_type=_TTF_Font,
    require_return=True)
...
_TTF_RenderUTF8_Solid = _dll.private_function('TTF_RenderUTF8_Solid',
    arg_types=[_TTF_Font, c_char_p, video.SDL_Color],
    return_type=POINTER(video.SDL_Surface), 
    require_return=True,
    dereference_return=True)
...
_TTF_RenderGlyph_Solid = _dll.private_function('TTF_RenderGlyph_Solid',
    arg_types=[_TTF_Font, c_ushort, video.SDL_Color],
    return_type=POINTER(video.SDL_Surface), 
    require_return=True,
    dereference_return=True)
...
_TTF_RenderUTF8_Shaded = _dll.private_function('TTF_RenderUTF8_Shaded',
    arg_types=[_TTF_Font, c_char_p, video.SDL_Color, video.SDL_Color],
    return_type=POINTER(video.SDL_Surface), 
    require_return=True,
    dereference_return=True)
...
_TTF_RenderGlyph_Shaded = _dll.private_function('TTF_RenderGlyph_Shaded',
    arg_types=[_TTF_Font, c_ushort, video.SDL_Color, video.SDL_Color],
    return_type=POINTER(video.SDL_Surface), 
    require_return=True,
    dereference_return=True)
