...
SDL_EnableUNICODE = dll.function('SDL_EnableUNICODE',
...
SDL_EnableKeyRepeat = dll.function('SDL_EnableKeyRepeat',
...
_SDL_GetKeyRepeat = dll.private_function('SDL_GetKeyRepeat',
...
_SDL_GetKeyState = dll.private_function('SDL_GetKeyState',
...
SDL_GetModState = dll.function('SDL_GetModState',
...
SDL_SetModState = dll.function('SDL_SetModState',
...
_SDL_GetKeyName = dll.private_function('SDL_GetKeyName',
    arg_types=[c_int],
