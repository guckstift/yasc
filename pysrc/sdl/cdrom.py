...
class SDL_CD(Structure):
    ...
    _fields_ = [('id', c_uint),
                ...
                ('cur_track', c_int),
                ('cur_frame', c_int),
                ('track', SDL_CDtrack * (constants.SDL_MAX_TRACKS + 1))]
...
def FRAMES_TO_MSF(frames):
    ...
    '''
    F = frames % constants.CD_FPS
    frames /= constants.CD_FPS
    S = frames % 60
    frames /= 60
    M = frames
    return (M, S, F)
...
def MSF_TO_FRAMES(minutes, seconds, frames):
    ...
    :rtype: int
    '''
    return constants.CD_FPS(minutes * 60 + seconds) + frames

SDL_CDNumDrives = dll.function('SDL_CDNumDrives',
...
SDL_CDName = dll.function('SDL_CDName',
...
SDL_CDOpen = dll.function('SDL_CDOpen',
...
SDL_CDStatus = dll.function('SDL_CDStatus',
...
SDL_CDPlayTracks = dll.function('SDL_CDPlayTracks',
    '''Play the given CD.
...
SDL_CDPlay = dll.function('SDL_CDPlay',
    '''Play the given CD.
...
SDL_CDPause = dll.function('SDL_CDPause',
    '''Pause play.
...
SDL_CDResume = dll.function('SDL_CDResume',
    '''Resume play.
...
SDL_CDStop = dll.function('SDL_CDStop',
    '''Stop play.
...
SDL_CDEject = dll.function('SDL_CDEject',
    '''Eject CD-ROM.
...
SDL_CDClose = dll.function('SDL_CDClose',
