...
class SDL_Event(Union):
    ...
    types = {
        constants.SDL_ACTIVEEVENT: (SDL_ActiveEvent, 'active'),
        constants.SDL_KEYDOWN: (SDL_KeyboardEvent, 'key'),
        constants.SDL_KEYUP: (SDL_KeyboardEvent, 'key'),
        constants.SDL_MOUSEMOTION: (SDL_MouseMotionEvent, 'motion'),
        constants.SDL_MOUSEBUTTONDOWN: (SDL_MouseButtonEvent, 'button'),
        constants.SDL_MOUSEBUTTONUP: (SDL_MouseButtonEvent, 'button'),
        constants.SDL_JOYAXISMOTION: (SDL_JoyAxisEvent, 'jaxis'),
        constants.SDL_JOYBALLMOTION: (SDL_JoyBallEvent, 'jball'),
        constants.SDL_JOYHATMOTION: (SDL_JoyHatEvent, 'jhat'),
        constants.SDL_JOYBUTTONDOWN: (SDL_JoyButtonEvent, 'jbutton'),
        constants.SDL_JOYBUTTONUP: (SDL_JoyButtonEvent, 'jbutton'),
        constants.SDL_VIDEORESIZE: (SDL_ResizeEvent, 'resize'),
        constants.SDL_VIDEOEXPOSE: (SDL_ExposeEvent, 'expose'),
        constants.SDL_QUIT: (SDL_QuitEvent, 'quit'),
        constants.SDL_SYSWMEVENT: (SDL_SysWMEvent, 'syswm')
    }
    ...
    def __repr__(self):
        ...
        elif self.type >= constants.SDL_USEREVENT: 
...
SDL_PumpEvents = dll.function('SDL_PumpEvents',
...
_SDL_PeepEvents = dll.private_function('SDL_PeepEvents',
...
def SDL_PeepEvents(numevents, action, mask):
    ...
    '''
    if action == constants.SDL_ADDEVENT:
...
def SDL_HaveEvents(mask):
    ...
    :return: True if at least one event matches the mask in the event
        queue.
    '''
    num = _SDL_PeepEvents(None, 1, constants.SDL_PEEKEVENT, mask)
    return num > 0

_SDL_PollEvent = dll.private_function('SDL_PollEvent',
...
_SDL_WaitEvent = dll.private_function('SDL_WaitEvent',
    arg_types=[POINTER(SDL_Event)],
    return_type=c_int)
...
SDL_PushEvent = dll.function('SDL_PushEvent',
...
_SDL_SetEventFilter = dll.private_function('SDL_SetEventFilter',
...
SDL_GetEventFilter = dll.function('SDL_GetEventFilter',
...
SDL_EventState = dll.function('SDL_EventState',
