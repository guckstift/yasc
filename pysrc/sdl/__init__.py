...
_SDL_Init = dll.private_function('SDL_Init',
...
_SDL_InitSubSystem = dll.private_function('SDL_InitSubSystem',
    arg_types=[ctypes.c_uint],
    return_type=ctypes.c_int)
...
SDL_QuitSubSystem = dll.function('SDL_QuitSubSystem',
...
SDL_WasInit = dll.function('SDL_WasInit',
...
SDL_Quit = dll.function('SDL_Quit',
